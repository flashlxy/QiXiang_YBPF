...
namespace PF.BLL.SQL
{
    public partial class Score_Day_BLL
    {
        ...
        public void Caculate20_ByYbUser(DateTime startDate, DateTime endDate)
        {
            ...
            {
                //当天日期
                DateTime cDay = startDate.AddDays(i);
                //当前天时间
                DateTime dayTime = DateTime.Parse(startDate.AddDays(i).ToShortDateString() + " 16:30");
                //当前天 所有人的数据
                List<BwYbs> dayList = list.Where(a => a.YBDateTime == dayTime).ToList();
                ...
                List<BwYbs> dayPersonList_集体 = dayList.Where(a => a.YBUserName == "集体").OrderBy(a => a.CountryCode).ToList();



                List<Score_Day> scorePersonList_集体 = new List<Score_Day>();

                //遍历每个人的数据得到每个人每天某个城市的数据
                foreach (BwYbs dayPerson in dayPersonList_集体)
                {
                    ...
                    scorePersonList_集体.Add(scoreDay);
                }

                Score_Day scorePerson_集体 = new Score_Day();
                scorePerson_集体.ScoreID = Guid.NewGuid();
                scorePerson_集体.YBDate = scorePersonList_集体.FirstOrDefault().YBDate;
                scorePerson_集体.YBTime = scorePersonList_集体.FirstOrDefault().YBTime;
                scorePerson_集体.YBUserName = scorePersonList_集体.FirstOrDefault().YBUserName;
                scorePerson_集体.YBUserID = scorePersonList_集体.FirstOrDefault().YBUserID;
                scorePerson_集体.CreateTime = DateTime.Now;



                scorePerson_集体.MaxTemp24 = scorePersonList_集体.Where(a => a.MaxTemp24 != null).Count() == 0 ? null : scorePersonList_集体.Sum(a => a.MaxTemp24);
                scorePerson_集体.MinTemp24 = scorePersonList_集体.Where(a => a.MinTemp24 != null).Count() == 0 ? null : scorePersonList_集体.Sum(a => a.MinTemp24);
                scorePerson_集体.MaxTemp48 = scorePersonList_集体.Where(a => a.MaxTemp48 != null).Count() == 0 ? null : scorePersonList_集体.Sum(a => a.MaxTemp48);
                scorePerson_集体.MinTemp48 = scorePersonList_集体.Where(a => a.MinTemp48 != null).Count() == 0 ? null : scorePersonList_集体.Sum(a => a.MinTemp48);
                scorePerson_集体.MaxTemp72 = scorePersonList_集体.Where(a => a.MaxTemp72 != null).Count() == 0 ? null : scorePersonList_集体.Sum(a => a.MaxTemp72);
                scorePerson_集体.MinTemp72 = scorePersonList_集体.Where(a => a.MinTemp72 != null).Count() == 0 ? null : scorePersonList_集体.Sum(a => a.MinTemp72);
                scorePerson_集体.RainShine24 = scorePersonList_集体.Where(a => a.RainShine24 != null).Count() == 0 ? null : scorePersonList_集体.Sum(a => a.RainShine24);
                scorePerson_集体.RainShine48 = scorePersonList_集体.Where(a => a.RainShine48 != null).Count() == 0 ? null : scorePersonList_集体.Sum(a => a.RainShine48);
                scorePerson_集体.RainShine72 = scorePersonList_集体.Where(a => a.RainShine72 != null).Count() == 0 ? null : scorePersonList_集体.Sum(a => a.RainShine72);
                scorePerson_集体.AllTotal = scorePersonList_集体.Where(a => a.AllTotal != null).Count() == 0 ? null : scorePersonList_集体.Sum(a => a.AllTotal);
                scorePerson_集体.Rainfall24 = scorePersonList_集体.Where(a => a.Rainfall24 != null).Count() == 0 ? null : scorePersonList_集体.Sum(a => a.Rainfall24);
                scorePerson_集体.Rainfall24Total = scorePersonList_集体.Where(a => a.Rainfall24Total != null).Count() == 0 ? null : scorePersonList_集体.Sum(a => a.Rainfall24Total);
                scorePerson_集体.Rainfall48 = scorePersonList_集体.Where(a => a.Rainfall48 != null).Count() == 0 ? null : scorePersonList_集体.Sum(a => a.Rainfall48);
                scorePerson_集体.Rainfall48Total = scorePersonList_集体.Where(a => a.Rainfall48Total != null).Count() == 0 ? null : scorePersonList_集体.Sum(a => a.Rainfall48Total);
                scorePerson_集体.Rainfall72 = scorePersonList_集体.Where(a => a.Rainfall72 != null).Count() == 0 ? null : scorePersonList_集体.Sum(a => a.Rainfall72);
                scorePerson_集体.Rainfall72Total = scorePersonList_集体.Where(a => a.Rainfall72Total != null).Count() == 0 ? null : scorePersonList_集体.Sum(a => a.Rainfall72Total);
                scorePerson_集体.Rainstorm24 = scorePersonList_集体.Where(a => a.Rainstorm24 != null).Count() == 0 ? null : scorePersonList_集体.Sum(a => a.Rainstorm24);
                scorePerson_集体.Rainstorm24Total = scorePersonList_集体.Where(a => a.Rainstorm24Total != null).Count() == 0 ? null : scorePersonList_集体.Sum(a => a.Rainstorm24Total);
                scorePerson_集体.Rainstorm48 = scorePersonList_集体.Where(a => a.Rainstorm48 != null).Count() == 0 ? null : scorePersonList_集体.Sum(a => a.Rainstorm48);
                scorePerson_集体.Rainstorm48Total = scorePersonList_集体.Where(a => a.Rainstorm48Total != null).Count() == 0 ? null : scorePersonList_集体.Sum(a => a.Rainstorm48Total);

                dal.Add(scorePerson_集体, false);
                ...
                List<Scheduling> schedulingDayList = schedulingList.Where(a => a.Date == cDay).ToList();


                //遍历当前天得到每个人数据(没有集体)
                foreach (Scheduling scheduling in schedulingDayList)
                {
                    //当前天当前预报员
                    string name = scheduling.YBUserName;



                    List<BwYbs> dayPersonList = dayList.Where(a => a.YBUserName == name).OrderBy(a => a.CountryCode).ToList();

                    if (dayPersonList.Count > 0)
                    {
                        List<Score_Day> scorePersonList = new List<Score_Day>();
                        ...
                        foreach (BwYbs dayPerson in dayPersonList)
                        {
                            ...
                            LiveData liveData24 = liveList
                                .Where(a => a.FDate == secondDay && a.CountryName == dayPerson.CountryName)
                                .FirstOrDefault();
                            LiveData liveData48 = liveList
                                .Where(a => a.FDate == thirdDay && a.CountryName == dayPerson.CountryName)
                                .FirstOrDefault();
                            LiveData liveData72 = liveList
                                .Where(a => a.FDate == thirsdDay && a.CountryName == dayPerson.CountryName)
                                .FirstOrDefault();

                            /////////////////温度
                            //24小时温度
                            decimal maxTempSpan24 =
                                Math.Abs((decimal)dayPerson.MaxTemp24 - (decimal)liveData24.MaxTemp);
                            if (maxTempSpan24 <= 2)
                            {
                                scoreDay.MaxTemp24 = 1;
                            }
                            ...
                            decimal minTempSpan24 =
                                Math.Abs((decimal)dayPerson.MinTemp24 - (decimal)liveData24.MinTemp);
                            if (minTempSpan24 <= 2)
                            {
                                scoreDay.MinTemp24 = 1;
                            }
                            ...
                            //48小时温度
                            decimal maxTempSpan48 =
                                Math.Abs((decimal)dayPerson.MaxTemp48 - (decimal)liveData48.MaxTemp);
                            if (maxTempSpan48 <= 2)
                            {
                                scoreDay.MaxTemp48 = 1;
                            }
                            ...
                            decimal minTempSpan48 =
                                Math.Abs((decimal)dayPerson.MinTemp48 - (decimal)liveData48.MinTemp);
                            if (minTempSpan48 <= 2)
                            {
                                scoreDay.MinTemp48 = 1;
                            }
                            ...
                            //72小时温度
                            decimal maxTempSpan72 =
                                Math.Abs((decimal)dayPerson.MaxTemp72 - (decimal)liveData72.MaxTemp);
                            if (maxTempSpan72 <= 2)
                            {
                                scoreDay.MaxTemp72 = 1;
                            }
                            ...
                            decimal minTempSpan72 =
                                Math.Abs((decimal)dayPerson.MinTemp72 - (decimal)liveData72.MinTemp);
                            if (minTempSpan72 <= 2)
                            {
                                scoreDay.MinTemp72 = 1;
                            }
                            ...
                            ///晴雨预报判断
                            /// 24小时
                            WeatherDictionary wd12 = wdList.Where(a => a.Code == dayPerson.TianQiCode12)
                                .FirstOrDefault();
                            WeatherDictionary wd24 = wdList.Where(a => a.Code == dayPerson.TianQiCode24)
                                .FirstOrDefault();
                            WeatherDictionary trueWd24 = (decimal)wd12.Priority <= (decimal)wd24.Priority
                                ? wd12
                                : wd24;
                            ...
                            ///晴雨预报判断
                            /// 48小时
                            WeatherDictionary wd36 = wdList.Where(a => a.Code == dayPerson.TianQiCode36)
                                .FirstOrDefault();
                            WeatherDictionary wd48 = wdList.Where(a => a.Code == dayPerson.TianQiCode48)
                                .FirstOrDefault();
                            WeatherDictionary trueWd48 = (decimal)wd36.Priority <= (decimal)wd48.Priority
                                ? wd36
                                : wd48;
                            ...
                            ///晴雨预报判断
                            /// 72小时
                            WeatherDictionary wd60 = wdList.Where(a => a.Code == dayPerson.TianQiCode60)
                                .FirstOrDefault();
                            WeatherDictionary wd72 = wdList.Where(a => a.Code == dayPerson.TianQiCode72)
                                .FirstOrDefault();
                            WeatherDictionary trueWd72 = (decimal)wd60.Priority <= (decimal)wd72.Priority
                                ? wd60
                                : wd72;
                        ...
                        scorePerson.MaxTemp24 = scorePersonList.Where(a => a.MaxTemp24 != null).Count() == 0
                            ? null
                            : scorePersonList.Sum(a => a.MaxTemp24);
                        scorePerson.MinTemp24 = scorePersonList.Where(a => a.MinTemp24 != null).Count() == 0
                            ? null
                            : scorePersonList.Sum(a => a.MinTemp24);
                        scorePerson.MaxTemp48 = scorePersonList.Where(a => a.MaxTemp48 != null).Count() == 0
                            ? null
                            : scorePersonList.Sum(a => a.MaxTemp48);
                        scorePerson.MinTemp48 = scorePersonList.Where(a => a.MinTemp48 != null).Count() == 0
                            ? null
                            : scorePersonList.Sum(a => a.MinTemp48);
                        scorePerson.MaxTemp72 = scorePersonList.Where(a => a.MaxTemp72 != null).Count() == 0
                            ? null
                            : scorePersonList.Sum(a => a.MaxTemp72);
                        scorePerson.MinTemp72 = scorePersonList.Where(a => a.MinTemp72 != null).Count() == 0
                            ? null
                            : scorePersonList.Sum(a => a.MinTemp72);
                        scorePerson.RainShine24 = scorePersonList.Where(a => a.RainShine24 != null).Count() == 0
                            ? null
                            : scorePersonList.Sum(a => a.RainShine24);
                        scorePerson.RainShine48 = scorePersonList.Where(a => a.RainShine48 != null).Count() == 0
                            ? null
                            : scorePersonList.Sum(a => a.RainShine48);
                        scorePerson.RainShine72 = scorePersonList.Where(a => a.RainShine72 != null).Count() == 0
                            ? null
                            : scorePersonList.Sum(a => a.RainShine72);
                        scorePerson.AllTotal = scorePersonList.Where(a => a.AllTotal != null).Count() == 0
                            ? null
                            : scorePersonList.Sum(a => a.AllTotal);
                        scorePerson.Rainfall24 = scorePersonList.Where(a => a.Rainfall24 != null).Count() == 0
                            ? null
                            : scorePersonList.Sum(a => a.Rainfall24);
                        scorePerson.Rainfall24Total = scorePersonList.Where(a => a.Rainfall24Total != null).Count() == 0
                            ? null
                            : scorePersonList.Sum(a => a.Rainfall24Total);
                        scorePerson.Rainfall48 = scorePersonList.Where(a => a.Rainfall48 != null).Count() == 0
                            ? null
                            : scorePersonList.Sum(a => a.Rainfall48);
                        scorePerson.Rainfall48Total = scorePersonList.Where(a => a.Rainfall48Total != null).Count() == 0
                            ? null
                            : scorePersonList.Sum(a => a.Rainfall48Total);
                        scorePerson.Rainfall72 = scorePersonList.Where(a => a.Rainfall72 != null).Count() == 0
                            ? null
                            : scorePersonList.Sum(a => a.Rainfall72);
                        scorePerson.Rainfall72Total = scorePersonList.Where(a => a.Rainfall72Total != null).Count() == 0
                            ? null
                            : scorePersonList.Sum(a => a.Rainfall72Total);
                        scorePerson.Rainstorm24 = scorePersonList.Where(a => a.Rainstorm24 != null).Count() == 0
                            ? null
                            : scorePersonList.Sum(a => a.Rainstorm24);
                        scorePerson.Rainstorm24Total =
                            scorePersonList.Where(a => a.Rainstorm24Total != null).Count() == 0
                                ? null
                                : scorePersonList.Sum(a => a.Rainstorm24Total);
                        scorePerson.Rainstorm48 = scorePersonList.Where(a => a.Rainstorm48 != null).Count() == 0
                            ? null
                            : scorePersonList.Sum(a => a.Rainstorm48);
                        scorePerson.Rainstorm48Total =
                            scorePersonList.Where(a => a.Rainstorm48Total != null).Count() == 0
                                ? null
                                : scorePersonList.Sum(a => a.Rainstorm48Total);
                    ...
                    else
                    {
                        ...
                        Score_Day scorePerson = new Score_Day();
                        scorePerson.ScoreID = Guid.NewGuid();
                        scorePerson.YBDate = scorePerson_集体.YBDate;
                        scorePerson.YBTime = scorePerson_集体.YBTime;
                        scorePerson.YBUserName = scheduling.YBUserName;
                        scorePerson.YBUserID = scheduling.YBUserID;
                        scorePerson.CreateTime = DateTime.Now;

                        scorePerson.Remark = "来自集体";

                        scorePerson.MaxTemp24 = scorePerson_集体.MaxTemp24;
                        scorePerson.MinTemp24 = scorePerson_集体.MinTemp24;
                        scorePerson.MaxTemp48 = scorePerson_集体.MaxTemp48;
                        scorePerson.MinTemp48 = scorePerson_集体.MinTemp48;
                        scorePerson.MaxTemp72 = scorePerson_集体.MaxTemp72;
                        scorePerson.MinTemp72 = scorePerson_集体.MinTemp72;
                        scorePerson.RainShine24 = scorePerson_集体.RainShine24;
                        scorePerson.RainShine48 = scorePerson_集体.RainShine48;
                        scorePerson.RainShine72 = scorePerson_集体.RainShine72;
                        scorePerson.AllTotal = scorePerson_集体.AllTotal;
                        scorePerson.Rainfall24 = scorePerson_集体.Rainfall24;
                        scorePerson.Rainfall24Total = scorePerson_集体.Rainfall24Total;
                        scorePerson.Rainfall48 = scorePerson_集体.Rainfall48;
                        scorePerson.Rainfall48Total = scorePerson_集体.Rainfall48Total;
                        scorePerson.Rainfall72 = scorePerson_集体.Rainfall72;
                        scorePerson.Rainfall72Total = scorePerson_集体.Rainfall72Total;
                        scorePerson.Rainstorm24 = scorePerson_集体.Rainstorm24;
                        scorePerson.Rainstorm24Total = scorePerson_集体.Rainstorm24Total;
                        scorePerson.Rainstorm48 = scorePerson_集体.Rainstorm48;
                        scorePerson.Rainstorm48Total = scorePerson_集体.Rainstorm48Total;
        ...
        public void Caculate08_ByYbUser(DateTime startDate, DateTime endDate)
        {
            ...
            {
                //当天日期（schedule专用）
                DateTime cDay = start_Yestoday.AddDays(i);
                ...
                foreach (Scheduling scheduling in schedulingDayList)
                {
                    ...
                    if (dayPersonList.Count > 0)
                    {
                        ...
                        foreach (BwYbs dayPerson in dayPersonList)
                        {
                            ...
                            LiveData liveData24 = liveList
                                .Where(a => a.FDate == currentDay && a.CountryName == dayPerson.CountryName)
                                .FirstOrDefault(); //08时预报应该与当前比较
                            LiveData liveData48 = liveList
                                .Where(a => a.FDate == secondDay && a.CountryName == dayPerson.CountryName)
                                .FirstOrDefault();
                            LiveData liveData72 = liveList
