...
namespace PF.Utility
{
    public static  class JavaScriptHelper
    {
        ...
        /// 页面加载效果
        /// </summary>
        /// <param name="message">加载提示语言</param>
        public static void Loading(string message)
        {
            ...
            HttpContext.Current.Response.Write("#loader {font-family:Tahoma, Helvetica, sans; font-size:16px; color:#000000; background-color:#FFFFFF; padding:10px 0 16px 0; margin:0 auto; display:block; width:130px; border:1px solid #5a667b; text-align:left; z-index:2;}");
            HttpContext.Current.Response.Write("#progress {height:15px; font-size:1px; width:1px; position:relative; top:1px; left:0px; background-color:#12c192;}");
            HttpContext.Current.Response.Write("#loader_bg {background-color:#e4e7eb; position:relative; top:8px; left:8px; height:17px; width:113px; font-size:1px;}");
            HttpContext.Current.Response.Write("</style>");
